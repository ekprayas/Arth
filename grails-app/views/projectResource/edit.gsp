	...
	<body>
	    ...
	    <div class="row">
    		<div class="large-12 columns">
				...
				<g:hasErrors bean="${projectResourceInstance}">
					<div class="alert-box alert" role="alert">
						<ul role="alert">
							<g:eachError bean="${projectResourceInstance}" var="error">
				...
				<g:form method="post" >
					...
					<g:hiddenField name="version" value="${projectResourceInstance?.version}" />
					<fieldset class="form">
