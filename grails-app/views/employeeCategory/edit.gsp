	...
	<body>
	    ...
	    <div class="row">
    		<div class="large-12 columns">
				...
				<g:hasErrors bean="${employeeCategoryInstance}">
					<div class="alert-box alert" role="alert">
						<ul role="alert">
							<g:eachError bean="${employeeCategoryInstance}" var="error">
				...
				<g:form method="post" >
					...
					<g:hiddenField name="version" value="${employeeCategoryInstance?.version}" />
					<fieldset class="form">
