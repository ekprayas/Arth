	...
	<body>
	    ...
	    <div class="row">
    		<div class="large-12 columns">
				...
				<g:hasErrors bean="${leaveEmployeeCategoryInstance}">
					<div class="alert-box alert" role="alert">
						<ul role="alert">
							<g:eachError bean="${leaveEmployeeCategoryInstance}" var="error">
				...
				<g:form method="post" >
					...
					<g:hiddenField name="version" value="${leaveEmployeeCategoryInstance?.version}" />
					<fieldset class="form">
